...
font-size: 16px;"> &nbsp; <a href="index.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
      ...
      <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
         		<h2>&nbsp&nbspView Health Tips</h2>
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          String sql ="select * from healthtips";
                                          ...
                                          <tbody>
                                                   ...
                                                   <td><%=resultSet.getString("tips") %></td>

                                                   
                                                   <td><a href="deleteghealthtips.jsp?id=<%=resultSet.getString("hid") %>" onclick="return confirm_alert(this);">Delete</a></td>
