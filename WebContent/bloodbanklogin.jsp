...
<body>
    <h1 style="color:orange; text-shadow: 0.5px 0.5px 0.5px red;">HAMARA SABKA BLOOD BANK</h1>
        ...
        <form action="BloodBankServlet" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" placeholder="Email" name="emailbb" required="required" />
                </div>
            </div>
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="password" class="form-control" placeholder="Password" name="passwordbb" required="required" />
                </div>
            </div>
