...
font-size: 16px;"> &nbsp; <a href="index.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <img src="assets/img/find_user.png" class="user-image img-responsive" style="height: 100px;"/>
				  ...
				  <li>
                        <a  href="depositMoney.jsp"><i class="fa fa-edit fa-3x"></i>Deposit Money</a>
                    </li>
                    <li>
                        <a  href="withdrawMoney.jsp"><i class="fa fa-edit fa-3x"></i>Withdraw Money</a>
                    </li>
                    <li>
                        <a  href="viewCustomerCashier.jsp"><i class="fa fa-edit fa-3x"></i>View Customers</a>
                    </li>
	                </ul>
      ...
      <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
         		<h2>&nbsp&nbspWithdraw Amount</h2>
         		 <div class="col-md-12">
          <div class="card">
        <form action="WithdrawMoney" method="post">
                ...
                <div class="form-group row">
                <input type="hidden" name="action" value="add"/>
    			<label for="inputEmail3" class="col-sm-3 form-control-label">Amount</label>
                  <div class="col-sm-9">
                    <textarea cols="7" rows="1" class="form-control" name="amt" placeholder="Enter Amount" onkeypress="return isNumberKey(event)" minlength="3" required></textarea>
                  </div>
                </div>
