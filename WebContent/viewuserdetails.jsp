           ...
           <div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered" style="display.none" >
                                          ...
                                          Connection conn=Bank_Database.Connect();
                              			  Integer uID=GetSet.getuID();
                                          statement=conn.createStatement();
                                          String sql ="select * from userbank where uid='"+uID+"'";
                                          ...
                                          <tbody>
                                                   ...
                                                   <td><%=resultSet.getString("uaddress") %></td>
                                                   <td><%=resultSet.getString("ucontact") %></td>
                                                   <td><%=resultSet.getString("ubloodgroup") %></td>
